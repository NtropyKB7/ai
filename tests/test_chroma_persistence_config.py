...
def test_environment_example_contains_names_without_credentials():
    ...
    assert values == {
        ...
        "OPENAI_CLASSIFICATION_MAX_CONCURRENCY": "4",
        "OPENAI_CLASSIFICATION_HTTP_TIMEOUT_SECONDS": "25",
        "OPENAI_CLASSIFICATION_TIMEOUT_SECONDS": "30",
        "OPENAI_CLASSIFICATION_MAX_RETRIES": "0",
        "OPENAI_CLASSIFICATION_CHUNK_SIZE": "20",
        "FINLIFE_API_KEY": "",
